<template>
    <div id="header-wrap" onload="startTime">
        <span class="time" id="text">hhh</span>
        管理员
    </div>
</template>

<script>
import { reactive, ref, computed, mo } from '@vue/composition-api';
export default {
    name: 'Header',
    setup(props,{root,refs}){
        ...
        let startTime = () =>{
            ...
            s = checkTime(s);
            strDate += "   "+ h + ':' + m + ':' + s;
            document.getElementById('text').innerHTML = strDate;
